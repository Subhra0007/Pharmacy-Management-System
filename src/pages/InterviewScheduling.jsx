...
import { CalendarCheck, Clock, CheckCircle, XCircle, Calendar, Plus, MapPin, Video, Phone, Users } from "lucide-react";
import { interviewSchedulingData } from "../data/interviewSchedulingData";

export default function InterviewScheduling() {
      const { darkMode } = useOutletContext();
      const { metrics, interviews } = interviewSchedulingData;
                                          ...
                                          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                                <div className="flex gap-4 items-start flex-1">
                                                      ...
                                                      <div className="flex gap-2">
                                                            ...
                                                            <img src={interview.interviewerAvatar} alt={interview.interviewer} className="w-10 h-10 rounded-full object-cover -ml-4 border-2 border-white dark:border-gray-800" />
                                                      </div>
