                  ...
                  <div className={`rounded-xl shadow-md overflow-hidden ${darkMode ? "bg-gray-800" : "bg-white"}`}>
                        ...
                        <div className="divide-y dark:divide-gray-700">
                              {meetings.map((meeting) => (
                                    ...
                                    ${meeting.status === 'Scheduled' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200' :
                                                                  meeting.status === 'Completed' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200' :
                                                                        'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200'}
                                `}>
                                                            {meeting.status}
                                                      </div>
                                                      <div className={`px-2 py-1 rounded text-xs font-medium 
                                    ${meeting.priority === 'Critical' ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200' :
                                                                  meeting.priority === 'High' ? 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200' :
