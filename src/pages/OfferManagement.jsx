...
import { FileSignature, CheckCircle, Clock, XCircle, Calendar, Plus, DollarSign, Briefcase, Award } from "lucide-react";
import { offerManagementData } from "../data/offerManagementData";

export default function OfferManagement() {
      const { darkMode } = useOutletContext();
      const { metrics, offers } = offerManagementData;
